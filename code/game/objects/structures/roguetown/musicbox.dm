...
/obj/structure/roguemachine/musicbox
	...
	desc = "Изобретено чудесное устройство для записи проповедей. Накормленный определенными насекомыми, он теперь приносит нам странную музыку из другого мира."
