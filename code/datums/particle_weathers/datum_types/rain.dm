...
/datum/particle_weather/rain_gentle
	...
	weather_messages = list("Я дрожу от холода. Стоит укрыться где-нибудь от дождя...")
...
/datum/particle_weather/rain_storm
	...
	indoor_weather_sounds = list(/datum/looping_sound/indoor_rain)
	weather_messages = list("Я чувствую, как вся моя одежда промокла до нитки.", "Ливень быстро усиливается! Скорее под крышу!")
