...
/obj/effect/temp_visual/stress_event
	icon = 'modular_twilight/icons/mob/overhead_effects.dmi'
	duration = 20
...
/mob/living/proc/play_stress_indicator()
	play_overhead_indicator('modular_twilight/icons/mob/overhead_effects.dmi', "stress", 15, OBJ_LAYER, private = TRUE, soundin = 'modular_twilight/sound/ddstress.ogg')

/mob/living/proc/play_relief_indicator()
	play_overhead_indicator('modular_twilight/icons/mob/overhead_effects.dmi', "relief", 15, OBJ_LAYER, private = TRUE, soundin = 'modular_twilight/sound/ddrelief.ogg')

/mob/living/proc/play_mental_break_indicator()
	play_overhead_indicator('modular_twilight/icons/mob/overhead_effects.dmi', "mentalbreak", 20, OBJ_LAYER)
	playsound(src, 'modular_twilight/sound/stressaffliction.ogg', 100, FALSE, ignore_walls = FALSE)
